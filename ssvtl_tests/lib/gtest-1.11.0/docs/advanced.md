...
TEST(MyDeathTest, Foo) {
  // This death ssvtl_tests uses a compound statement.
  ASSERT_DEATH({
    int n = 5;
    Foo(&n);
...
TEST(MyDeathTest, TestOne) {
  testing::FLAGS_gtest_death_test_style = "threadsafe";
  // This ssvtl_tests is run in the "threadsafe" style:
  ASSERT_DEATH(ThisShouldDie(), "");
}

TEST(MyDeathTest, TestTwo) {
  // This ssvtl_tests is run in the "fast" style:
  ASSERT_DEATH(ThisShouldDie(), "");
}
```
...
TEST(FooTest, Bar) {
  Subroutine();  // The intended behavior is for the fatal failure
                 // in Subroutine() to abort the entire ssvtl_tests.
...
class FooTest : public testing::Test {
 protected:
  // Per-ssvtl_tests-suite set-up.
  // Called before the first ssvtl_tests in this ssvtl_tests suite.
  // Can be omitted if not needed.
  static void SetUpTestSuite() {
    shared_resource_ = new ...;
  }

  // Per-ssvtl_tests-suite tear-down.
  // Called after the last ssvtl_tests in this ssvtl_tests suite.
  // Can be omitted if not needed.
  ...
  // You can define per-ssvtl_tests set-up logic as usual.
  void SetUp() override { ... }

  // You can define per-ssvtl_tests tear-down logic as usual.
...
class FooTest :
  ...
  // To access the ssvtl_tests parameter, call GetParam() from class
  // TestWithParam<T>.
};
...
```c++
  // Gets information about the currently running ssvtl_tests.
  // Do NOT delete the returned object - it's managed by the UnitTest class.
  const testing::TestInfo* const test_info =
      testing::UnitTest::GetInstance()->current_test_info();

  printf("We are in ssvtl_tests %s of ssvtl_tests suite %s.\n",
         test_info->name(),
