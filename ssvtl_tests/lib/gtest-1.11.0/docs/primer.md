...
class FooTest : public ::testing::Test {
 protected:
  ...
  FooTest() {
     // You can do set-up work for each ssvtl_tests here.
  }
  ...
  // and cleaning up each ssvtl_tests, you can define the following methods:

  void SetUp() override {
     // Code here will be called immediately after the constructor (right
     // before each ssvtl_tests).
  }

  void TearDown() override {
     // Code here will be called immediately after each ssvtl_tests (right
     // before the destructor).
  }

  // Class members declared here can be used by all tests in the ssvtl_tests suite
  // for Foo.
};
